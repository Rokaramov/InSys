...
<div class="container wrapper">
	<form class="biba" action="${pageContext.request.contextPath}/Writer" method="post">
		<H1 align="center">Здесь можно сменить процентную ставку</H1>
			...
			<input class="input" type="number" name="firstAdmPercent" id="firstAdmPercent" value="10">
			<label>%</label>
			<br>
			<br>
			<br>
			<label for="third">Введите вторую процентную ставку</label>
			<input class="input" type="number" name="secondAdmPercent" id="secondAdmPercent" value="15">
			<label>%</label>
			<br>
			<br>
			<br>
			<label for="fourth">Введите третью процентную ставку</label>
			<input class="input" type="number" name="thirdAdmPercent" id="thirdAdmPercent" value="20">
			<label>%</label>
			<br>
			<br>
